<nav x-data="{ open: false }" class="bg-white dark:bg-slate-900 dark:border-none border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('idea.index') }}" :active="request()->routeIs('idea.index')">
                        {{ __('global.Ideas') }}
                    </x-jet-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <!-- Dark mode switcher -->
                <div class="switcher mr-4 mt-2">
                    <button type="button" x-bind:class="darkMode ? 'bg-slate-800' : 'bg-gray-200'"
                        ...
                        <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        ...
                                        <svg class="ml-2 -mr-0.5 h-4 w-4 dark:text-white" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                <!-- Responsive Notifications dropdown - temporary -->
                @auth
                    <livewire:comment-notifications />
                @endauth
