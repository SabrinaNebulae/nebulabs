...
>
    ...
    >
        <div class="fixed inset-0 bg-gray-500 dark:text-white bg-opacity-75 transition-opacity" aria-hidden="true"></div>
        ...
        >
            <div class="bg-white dark:bg-slate-700 dark:text-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class="bg-gray-50 dark:bg-slate-700 dark:text-white  px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
